...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5bb6a02c2bbde0fc5b6702b499544516) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/bean-code/torch-chat";
          synopsis = "just_chat";
          description =
            Some [OASISText.Para "Secure chat server application."];
          categories = [];
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("npm", ["install"])))];
               post_command =
                 [(OASISExpr.EBool true, Some (("sh", ["post_build.sh"])))]
            };
          ...
          clean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("sh", ["post_clean.sh"])))]
            };
          distclean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("colors_js", None);
                           FindlibPackage ("blessed", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\r\159Âæ¥\147µ\133A9S±£÷\015\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
